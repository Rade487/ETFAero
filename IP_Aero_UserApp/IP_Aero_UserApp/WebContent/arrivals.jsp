...
<div class="column-container">
    ...
    <div class="col-75">
		...
		<table id="table">
			<caption>Svi danasnji dolasci</caption>
			<thead>
				<tr>
			...
			<tbody>
				<c:forEach var="flight" items="${flightBean.getAll('today')}">
			...
			<caption>Svi jucerasnji dolasci</caption>
			<thead>
				<tr>
					<th>Polazna lokacija</th>
					<th>Odrediste</th>
			...
			<tbody>
				<c:forEach var="flight" items="${flightBean.getAll('yesterday')}">
		...
		<table id="tomorrowtable" style="display:none"> 
			<caption>Svi sutrasnji dolasci</caption>
			<thead>
				<tr>
					<th>Polazna lokacija</th>
					<th>Odrediste</th>
			...
			<tbody>
				<c:forEach var="flight" items="${flightBean.getAll('tomorrow')}">
...
<script>
setInterval(ajax_call_arrivals, 1000 * 60);
</script>
