...
public class RSSFeedWriter {
    ...
    public void write() throws Exception {
        ...
        for (Flight flight: rssfeed.getMessages()) {
            eventWriter.add(eventFactory.createStartElement("", "", "item"));
            eventWriter.add(end);
            createNode(eventWriter, "title", flight.getFile());
            createNode(eventWriter, "description", flight.getCargo());
            createNode(eventWriter, "link", flight.getCargo());
            createNode(eventWriter, "author", flight.getCargo());
            createNode(eventWriter, "guid", flight.getCargo());
            eventWriter.add(end);
